/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 019079fd340eae4057f745ec2cc4c1a1)
// Runtime types generated with workerd@1.20260301.1 2026-03-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OutlineDeepAgent" | "OutlineReactAgent" | "OutlineWorkflowAgent";
	}
	interface Env {
		OPENROUTER_API_KEY: string;
		OUTLINE_DEEP_AGENT: DurableObjectNamespace<import("./src/index").OutlineDeepAgent>;
		OUTLINE_REACT_AGENT: DurableObjectNamespace<import("./src/index").OutlineReactAgent>;
		OUTLINE_WORKFLOW_AGENT: DurableObjectNamespace<import("./src/index").OutlineWorkflowAgent>;
	}
}
